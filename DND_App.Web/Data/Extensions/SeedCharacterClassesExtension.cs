    ...
    public static class SeedCharacterClassesExtension
    {
        public static void SeedCharacterClasses(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CharacterClass>().HasData(
                 ...
                 {
                     Id = 1,
                     Name = Constants.Classes.Barbarian,
                     HitDie = 12,
                 ...
                 {
                     Id = 5,
                     Name = Constants.Classes.Fighter,
                     HitDie = 10,
                 ...
                 {
                     Id = 7,
                     Name = Constants.Classes.Paladin,
                     HitDie = 10,
                 ...
                 {
                     Id = 10,
                     Name = Constants.Classes.Sorcerer,
                     HitDie = 6,
                 ...
                 {
                     Id = 11,
                     Name = Constants.Classes.Warlock,
                     HitDie = 8,
