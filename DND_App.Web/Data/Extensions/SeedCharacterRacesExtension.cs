    ...
    public static class SeedCharacterRacesExtension
    {
        public static void SeedCharacterRaces (this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CharacterRace>().HasData(
                ...
                {
                    Id = 1,
                    Name = Constants.Races.AirGenasi,
                ...
                {
                    Id = 2,
                    Name = Constants.Races.Dragonborn,
                ...
                {
                    Id = 7,
                    Name = Constants.Races.EarthGenasi,
                ...
                {
                    Id = 8,
                    Name = Constants.Races.FireGenasi,
                ...
                {
                    Id = 9,
                    Name = Constants.Races.WaterGenasi,
                ...
                {
                    Id = 20,
                    Name = Constants.Races.YuanTiPureblood,
